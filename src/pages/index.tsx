  ...
  return (
    ...
    <div className='w-full h-screen  flex flex-col justify-center items-center '>
      ...
      <p className='m-2'>Silakan masuk untuk mendapatkan akses.</p>
        <button type="button" className="text-white bg-blue-500 hover:bg-blue-400 focus:ring-2 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-500 dark:hover:bg-blue-500 focus:outline-none dark:focus:ring-blue-200 w-1/5"><a href="login">Login</a></button>
